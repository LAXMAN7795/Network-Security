...
# Configuration for data ingestionConfig
...
MONGO_DB_URL = os.getenv("MONGO_DB_URL") # Get MongoDB URL from environment variables
...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        try:
            ...
            if "_id" in dataframe.columns:# Check if '_id' column exists
